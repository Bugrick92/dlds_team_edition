...
# Punkteverwaltung
scoreboard objectives add dlds_score dummy "Punkte" 
...
scoreboard objectives add zombified_piglin_killed minecraft.killed:minecraft.zombified_piglin
scoreboard objectives add piglin_killed minecraft.killed:minecraft.piglin
scoreboard objectives add magma_cube_killed minecraft.killed:minecraft.magma_cube
scoreboard objectives add hoglin_killed minecraft.killed:minecraft.hoglin
scoreboard objectives add mooshroom_killed minecraft.killed:minecraft.mooshroom
scoreboard objectives add polar_bear_killed minecraft.killed:minecraft.polar_bear
scoreboard objectives add axolotl_killed minecraft.killed:minecraft.axolotl
scoreboard objectives add parrot_killed minecraft.killed:minecraft.parrot
scoreboard objectives add iron_golem_killed minecraft.killed:minecraft.iron_golem
scoreboard objectives add snow_golem_killed minecraft.killed:minecraft.snow_golem
scoreboard objectives add llama_killed minecraft.killed:minecraft.llama
...
scoreboard objectives add cave_spider_killed minecraft.killed:minecraft.cave_spider
scoreboard objectives add phantom_killed minecraft.killed:minecraft.phantom
scoreboard objectives add blaze_killed minecraft.killed:minecraft.blaze
